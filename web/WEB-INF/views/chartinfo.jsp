...
<div id="box">
    ...
    <div id="body">
        ...
        <h4 align="left"><span class="reusableColor3 letterSpac">收货人</span><span class="reusableColor3 letterSpac1">：</span>${meradd.recman}<br />
            ...
            <span class="reusableColor3">联系方式：</span>${meradd.tel}</h4>
                    ...
                    <tr>
                        <td class="typeTd2"><span class="addDeleteSty addFontCol"><a href="#"><span class="addFontCol">修改</span></a><span class="addFontCol">　|</span>　<a href="#"><span class="addFontCol">删除</span></a></span><span class="addSpanSty"><a href="<%=request.getContextPath()%>/chart/chartorder"><img src="<%=request.getContextPath()%>/images/button_qr.gif" border="0" onclick="#" /></a></span><br />
                        </td>
                    </tr>
                    <tr>
                        <td></td>
